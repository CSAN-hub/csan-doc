...
CSAN (https://help.csanhub.org/docs/intro) propose une version de Kaniko maintenue par Chainguards (https://github.com/chainguard-forks/kaniko) et disponible via l'image `csanhub.org/kaniko/` :
...
2. Cache pour accélérer les builds
